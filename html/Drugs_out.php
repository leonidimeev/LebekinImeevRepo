...
<?php
	...
	$SQLquery = 'SELECT DrugsNew.ID, DrugsNew.Name, DrugsNew.Image, Makers.Name, Medicine.Name FROM DrugsNew JOIN Makers ON DrugsNew.Maker=Makers.ID  JOIN Medicine ON DrugsNew.Medicine=Medicine.ID';
