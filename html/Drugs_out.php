...
<?php
	...
	$SQLquery = 'SELECT DrugsNew.ID, DrugsNew.Name, DrugsNew.Image, Makers.Name, Medicine.Name FROM DrugsNew AS a JOIN Makers AS b ON a.Maker=b.ID  JOIN Medicine AS d ON a.Medicine=d.ID';
